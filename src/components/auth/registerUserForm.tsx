                  ...
                  <form onSubmit={form.handleSubmit(onSubmit)}>
                    <div className="flex flex-col gap-6">
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <Input {...field} className="border-card/50" />
                              <FormMessage />
                            </FormItem>
                          )}
                        />
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <Input type="password" {...field} className="border-card/50" />
                              <FormMessage />
                            </FormItem>
                          )}
                        />
                      ...
                      <div className="flex flex-col gap-3">
                        ...
                        <p className="text-muted-foreground text-sm text-center">Already have an account? <Link href="/login" className="underline">Login</Link> here</p>
                      </div>
                    </div>
                  </form>
                </Form>
